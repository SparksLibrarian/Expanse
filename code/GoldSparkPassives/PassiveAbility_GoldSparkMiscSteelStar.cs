...
// Type: GoldSparkPassives.PassiveAbility_GoldSparkMiscSteelStar
...
{
  public class PassiveAbility_GoldSparkMiscSteelStar : PassiveAbilityBase
  {
    public override string debugDesc => "Block Dice Power +2";
