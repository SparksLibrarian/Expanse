...
// Type: GoldSparkPassives.PassiveAbility_GoldSparkMiscEvasive2
...
{
  public class PassiveAbility_GoldSparkMiscEvasive2 : PassiveAbilityBase
  {
    public override string debugDesc => "Evade Dice Power +2";
